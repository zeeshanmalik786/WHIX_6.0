from unified_processing.preprocess  import preprocessor
from unified_processing.config import config
...
class unified_process:
    ...
    def __whix_unified_processing__(self, run_date):
        ...
        self.spark.sql(
            "INSERT INTO default.iptv_whix_raw_staging_two_historical SELECT * from default.iptv_whix_raw_staging_two")
