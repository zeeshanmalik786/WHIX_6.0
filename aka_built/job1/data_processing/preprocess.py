...
class preprocessor:
    ...
    @staticmethod
    def join_six_frames(frame1, frame2, frame3, frame4, frame5, frame6, jointype, key):

        df_join_1 = frame1.join(frame2, on=key, how=jointype)
        df_join_2 = df_join_1.join(frame3, on=key, how=jointype)
        df_join_3 = df_join_2.join(frame4, on=key, how=jointype)
        df_join_4 = df_join_3.join(frame5, on=key, how=jointype)
        df = df_join_4.join(frame6, on=key, how=jointype)
