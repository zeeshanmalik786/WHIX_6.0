    ...
    def __score__(self, run_date, hour):
        ...
        wifi_happiness_index=self.obj.get_data("default.iptv_whix_raw_staging_two_historical", ["accountSourceId",
            ...
            withColumn("device_class", func.when(col("med_maxrx")<=144,"Type 1 Device").\
                       ...
                       otherwise(func.when((col("med_maxrx")>444),"Type 111 Device").otherwise("unknown")))).\
            withColumn("deviceType", func.when((col("deviceType").isNull()) | (col("deviceType")==""),col("deviceType")).\
                       otherwise("unknown")). \
            withColumn("deviceModel", func.when((col("deviceModel").isNull()) | (col("deviceModel")==""), lit("unknown")). \
                                               otherwise(col("deviceModel"))). \
            withColumn("streamingDevice", func.when((col("streamingDevice").isNotNull()) | (col("streamingDevice")==""), lit("unknown")). \
            ...
            withColumn("norm_rssi", func.when((col("GW_MODEL")=='XB6-A') &
                                              (col("med_maxrx")<=144) &
                                              (col("tag")=="2G"),func.round((col("med_rssi") - self.xb6aminrssi_lower_twog)/(self.xb6amaxrssi_lower_twog - self.xb6aminrssi_lower_twog),2)).\
                           otherwise(func.when((col("GW_MODEL")=='XB6-A') &
                                              (col("med_maxrx")<=144) &
                                              (col("tag")=="5G"),func.round((col("med_rssi") - self.xb6aminrssi_lower_fiveg)/(self.xb6amaxrssi_lower_fiveg - self.xb6aminrssi_lower_fiveg),2)).\
                           otherwise(func.when((col("GW_MODEL")=='XB6-A') &
                                               (col("med_maxrx")>144) & (col("med_maxrx")<=444) &
                                               (col("tag")=="2G"),func.round((col("med_rssi") - self.xb6aminrssi_middle_twog)/(self.xb6amaxrssi_middle_twog - self.xb6aminrssi_middle_twog),2)).\
                           otherwise(func.when((col("GW_MODEL")=='XB6-A') &
                                               (col("med_maxrx")>144) & (col("med_maxrx")<=444) &
                                               (col("tag")=="5G"),func.round((col("med_rssi") - self.xb6aminrssi_middle_fiveg)/(self.xb6amaxrssi_middle_fiveg - self.xb6aminrssi_middle_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB6-A') &
                                           (col("med_maxrx") > 444) &
                                           (col("tag") == "2G"), func.round((col("med_rssi") - self.xb6aminrssi_high_twog) / (self.xb6amaxrssi_high_twog - self.xb6aminrssi_high_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB6-A') &
                                           (col("med_maxrx") > 444) &
                                           (col("tag") == "5G"), func.round((col("med_rssi") - self.xb6aminrssi_high_fiveg) / (self.xb6amaxrssi_high_fiveg - self.xb6aminrssi_high_fiveg),2)).\
                           otherwise(func.when((col("GW_MODEL") == 'XB6-T') &
                                           (col("med_maxrx") <= 144) &
                                           (col("tag") == "2G"), func.round((col("med_rssi") - self.xb6tminrssi_lower_twog) / (self.xb6tmaxrssi_lower_twog - self.xb6tminrssi_lower_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB6-T') &
                                            (col("med_maxrx") <= 144) &
                                            (col("tag") == "5G"), func.round((col("med_rssi") - self.xb6tminrssi_lower_fiveg) / (self.xb6tmaxrssi_lower_fiveg - self.xb6tminrssi_lower_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB6-T') &
                                            (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                            (col("tag") == "2G"), func.round((col("med_rssi") - self.xb6tminrssi_middle_twog) / (self.xb6tmaxrssi_middle_twog - self.xb6tminrssi_middle_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB6-T') &
                                            (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                            (col("tag") == "5G"), func.round((col("med_rssi") - self.xb6tminrssi_middle_fiveg) / (self.xb6tmaxrssi_middle_fiveg - self.xb6tminrssi_middle_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB6-T') &
                                            (col("med_maxrx") > 444) &
                                            (col("tag") == "2G"), func.round((col("med_rssi") - self.xb6tminrssi_high_twog) / (self.xb6tmaxrssi_high_twog - self.xb6tminrssi_high_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB6-T') &
                                            (col("med_maxrx") > 444) &
                                            (col("tag") == "5G"), func.round((col("med_rssi") - self.xb6tminrssi_high_fiveg) / (self.xb6tmaxrssi_high_fiveg - self.xb6tminrssi_high_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                            (col("med_maxrx") <= 144) &
                                            (col("tag") == "2G"), func.round((col("med_rssi") - self.xb7cminrssi_lower_twog) / (self.xb7cmaxrssi_lower_twog - self.xb7cminrssi_lower_twog), 2)).\
                           otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                            (col("med_maxrx") <= 144) & (col("tag") == "5G"), func.round((col("med_rssi") - self.xb7cminrssi_lower_fiveg) / (self.xb7cmaxrssi_lower_fiveg - self.xb7cminrssi_lower_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                            (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                            (col("tag") == "2G"), func.round((col("med_rssi") - self.xb7cminrssi_middle_twog) / (self.xb7cmaxrssi_middle_twog - self.xb7cminrssi_middle_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                            (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                            (col("tag") == "5G"), func.round((col("med_rssi") - self.xb7cminrssi_middle_fiveg) / (self.xb7cmaxrssi_middle_fiveg - self.xb7cminrssi_middle_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                            (col("med_maxrx") > 444) &
                                            (col("tag") == "2G"), func.round((col("med_rssi") - self.xb7cminrssi_high_twog) / (self.xb7cmaxrssi_high_twog - self.xb7cminrssi_high_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                            (col("med_maxrx") > 444) & (col("tag") == "5G"), func.round((col("med_rssi") - self.xb7cminrssi_high_fiveg) / (self.xb7cmaxrssi_high_fiveg - self.xb7cminrssi_high_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                            (col("med_maxrx") <= 144) & (col("tag") == "5G"), func.round((col("med_rssi") - self.xb7tminrssi_lower_fiveg) / (self.xb7tmaxrssi_lower_fiveg - self.xb7tminrssi_lower_fiveg), 2)).\
                           otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                            (col("med_maxrx") <= 144) & (col("tag") == "2G"), func.round((col("med_rssi") - self.xb7tminrssi_lower_twog) / (self.xb7tmaxrssi_lower_twog - self.xb7tminrssi_lower_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                               (col("med_maxrx") <= 144) & (col("tag") == "5G"), func.round((col("med_rssi") - self.xb7tminrssi_lower_fiveg) / (self.xb7tmaxrssi_lower_fiveg - self.xb7tminrssi_lower_fiveg), 2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                               (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                               (col("tag") == "2G"), func.round((col("med_rssi") - self.xb7tminrssi_middle_twog) / (self.xb7tmaxrssi_middle_twog - self.xb7tminrssi_middle_twog), 2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                               (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                               (col("tag") == "5G"), func.round((col("med_rssi") - self.xb7tminrssi_middle_fiveg) / (self.xb7tmaxrssi_middle_fiveg - self.xb7tminrssi_middle_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                            (col("med_maxrx") > 444) &
                                            (col("tag") == "2G"), func.round((col("med_rssi") - self.xb7tminrssi_high_twog) / (self.xb7tmaxrssi_high_twog - self.xb7tminrssi_high_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                            (col("med_maxrx") > 444) &
                                            (col("tag") == "5G"), func.round((col("med_rssi") - self.xb7tminrssi_high_fiveg) / (self.xb7tmaxrssi_high_fiveg - self.xb7tminrssi_high_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                            (col("med_maxrx") <= 144) & (col("tag") == "2G"), func.round((col("med_rssi") - self.xb8tminrssi_lower_twog) / (self.xb8tmaxrssi_lower_twog - self.xb8tminrssi_lower_twog), 2)).\
                           otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                            (col("med_maxrx") <= 144) &
                                            (col("tag") == "5G"), func.round((col("med_rssi") - self.xb8tminrssi_lower_fiveg) / (self.xb8tmaxrssi_lower_fiveg - self.xb8tminrssi_lower_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                            (col("med_maxrx") <= 144) & (col("tag") == "6G"), func.round((col("med_rssi") - self.xb8tminrssi_lower_sixg) / (self.xb8tmaxrssi_lower_sixg - self.xb8tminrssi_lower_sixg), 2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                            (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                            (col("tag") == "2G"), func.round((col("med_rssi") - self.xb8tminrssi_middle_twog) / (self.xb8tmaxrssi_middle_twog - self.xb8tminrssi_middle_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                            (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                            (col("tag") == "5G"), func.round((col("med_rssi") - self.xb8tminrssi_middle_fiveg) / (self.xb8tmaxrssi_middle_fiveg - self.xb8tminrssi_middle_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                            (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                            (col("tag") == "6G"), func.round((col("med_rssi") - self.xb8tminrssi_middle_sixg) / (self.xb8tmaxrssi_middle_sixg - self.xb8tminrssi_middle_sixg), 2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB8-T') &(col("med_maxrx") > 444) &
                                            (col("tag") == "2G"), func.round((col("med_rssi") - self.xb8tminrssi_high_twog) / (self.xb8tmaxrssi_high_twog - self.xb8tminrssi_high_twog),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB8-T') &(col("med_maxrx") > 444) &
                                            (col("tag") == "5G"), func.round((col("med_rssi") - self.xb8tminrssi_high_fiveg) / (self.xb8tmaxrssi_high_fiveg - self.xb8tminrssi_high_fiveg),2)). \
                           otherwise(func.when((col("GW_MODEL") == 'XB8-T') &(col("med_maxrx") > 444) &
        ...
        withColumn("norm_snr", func.when((col("GW_MODEL") == 'XB6-A') &
                          ...
                          otherwise(func.when((col("GW_MODEL") == 'XB6-A') &
                                       (col("med_maxrx") <= 144) &
                                       (col("tag") == "5G"), func.round((col("med_snr") - self.xb6aminsnr_lower_fiveg) / (self.xb6amaxsnr_lower_fiveg - self.xb6aminsnr_lower_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB6-A') &
                                                 (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                                 (col("tag") == "2G"), func.round((col("med_snr") - self.xb6aminsnr_middle_twog) / (self.xb6amaxsnr_middle_twog - self.xb6aminsnr_middle_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB6-A') &
                                                 (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                                 (col("tag") == "5G"), func.round(
                                                 (col("med_snr") - self.xb6aminsnr_middle_fiveg) / (self.xb6amaxsnr_middle_fiveg - self.xb6aminsnr_middle_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB6-A') &
                                                 (col("med_maxrx") > 444) &
                                                 (col("tag") == "2G"), func.round((col("med_snr") - self.xb6aminsnr_high_twog) / (self.xb6amaxsnr_high_twog - self.xb6aminsnr_high_twog),2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB6-A') &
                                              (col("med_maxrx") > 444) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb6aminsnr_high_fiveg) / (self.xb6amaxsnr_high_fiveg - self.xb6aminsnr_high_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB6-T') &
                                              (col("med_maxrx") <= 144) &
                                              (col("tag") == "2G"),func.round((col("med_snr") - self.xb6tminsnr_lower_twog) / (self.xb6tmaxsnr_lower_twog - self.xb6tminsnr_lower_twog),2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB6-T') &(col("med_maxrx") <= 144) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb6tminsnr_lower_fiveg) / (self.xb6tmaxsnr_lower_fiveg - self.xb6tminsnr_lower_fiveg), 2)).\
                          otherwise(func.when((col("GW_MODEL") == 'XB6-T') & (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb6tminsnr_middle_twog) / (self.xb6tmaxsnr_middle_twog - self.xb6tminsnr_middle_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB6-T') &(col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb6tminsnr_middle_fiveg) / (self.xb6tmaxsnr_middle_fiveg - self.xb6tminsnr_middle_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB6-T') &
                                              (col("med_maxrx") > 444) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb6tminsnr_high_twog) / (self.xb6tmaxsnr_high_twog - self.xb6tminsnr_high_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB6-T') &
                                              (col("med_maxrx") > 444) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb6tminsnr_high_fiveg) / (self.xb6tmaxsnr_high_fiveg - self.xb6tminsnr_high_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                              (col("med_maxrx") <= 144) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb7cminsnr_lower_twog) / (self.xb7cmaxsnr_lower_twog - self.xb7cminsnr_lower_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                              (col("med_maxrx") <= 144) & (
                                               col("tag") == "5G"),func.round((col("med_snr") - self.xb7cminsnr_lower_fiveg) / (self.xb7cmaxsnr_lower_fiveg - self.xb7cminsnr_lower_fiveg),2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                              (col("med_maxrx") > 144) &
                                              (col("med_maxrx") <= 444) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb7cminsnr_middle_twog) / (self.xb7cmaxsnr_middle_twog - self.xb7cminsnr_middle_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                              (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb7cminsnr_middle_fiveg) / (self.xb7cmaxsnr_middle_fiveg - self.xb7cminsnr_middle_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                              (col("med_maxrx") > 444) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb7cminsnr_high_twog) / (self.xb7cmaxsnr_high_twog - self.xb7cminsnr_high_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-C') &
                                              (col("med_maxrx") > 444) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb7cminsnr_high_fiveg) / (self.xb7cmaxsnr_high_fiveg - self.xb7cminsnr_high_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                              (col("med_maxrx") <= 144) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb7tminsnr_lower_fiveg) / (self.xb7tmaxsnr_lower_fiveg - self.xb7tminsnr_lower_fiveg),2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                              (col("med_maxrx") <= 144) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb7tminrssi_lower_twog) / (self.xb7tmaxrssi_lower_twog - self.xb7tminrssi_lower_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                              (col("med_maxrx") <= 144) &
                                              (col("tag") == "5G"),func.round((col("med_snr") - self.xb7tminsnr_lower_fiveg) / (self.xb7tmaxsnr_lower_fiveg - self.xb7tminsnr_lower_fiveg),2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                              (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb7tminsnr_middle_twog) / (self.xb7tmaxsnr_middle_twog - self.xb7tminsnr_middle_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                              (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb7tminsnr_middle_fiveg) / (self.xb7tmaxsnr_middle_fiveg - self.xb7tminsnr_middle_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                              (col("med_maxrx") > 444) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb7tminsnr_high_twog) / (self.xb7tmaxsnr_high_twog - self.xb7tminsnr_high_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB7-T') &
                                              (col("med_maxrx") > 444) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb7tminsnr_high_fiveg) / (self.xb7tmaxsnr_high_fiveg - self.xb7tminsnr_high_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                              (col("med_maxrx") <= 144) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb8tminsnr_lower_twog) / (self.xb8tmaxsnr_lower_twog - self.xb8tminsnr_lower_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                              (col("med_maxrx") <= 144) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb8tminsnr_lower_fiveg) / (self.xb8tmaxsnr_lower_fiveg - self.xb8tminsnr_lower_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                              (col("med_maxrx") <= 144) & (
                                               col("tag") == "6G"),func.round((col("med_snr") - self.xb8tminsnr_lower_sixg) / (self.xb8tmaxsnr_lower_sixg - self.xb8tminsnr_lower_sixg),2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                              (col("med_maxrx") > 144) &
                                              (col("med_maxrx") <= 444) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb8tminsnr_middle_twog) / (self.xb8tmaxsnr_middle_twog - self.xb8tminsnr_middle_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                              (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb8tminsnr_middle_fiveg) / (self.xb8tmaxsnr_middle_fiveg - self.xb8tminsnr_middle_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                              (col("med_maxrx") > 144) & (col("med_maxrx") <= 444) &
                                              (col("tag") == "6G"), func.round((col("med_snr") - self.xb8tminsnr_middle_sixg) / (self.xb8tmaxsnr_middle_sixg - self.xb8tminsnr_middle_sixg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB8-T') &
                                              (col("med_maxrx") > 444) &
                                              (col("tag") == "2G"), func.round((col("med_snr") - self.xb8tminsnr_high_twog) / (self.xb8tmaxsnr_high_twog - self.xb8tminsnr_high_twog), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB8-T') & (col("med_maxrx") > 444) &
                                              (col("tag") == "5G"), func.round((col("med_snr") - self.xb8tminsnr_high_fiveg) / (self.xb8tmaxsnr_high_fiveg - self.xb8tminsnr_high_fiveg), 2)). \
                          otherwise(func.when((col("GW_MODEL") == 'XB8-T') & (col("med_maxrx") > 444) &
                                              (col("tag") == "6G"), func.round((col("med_snr") - self.xb8tminsnr_high_sixg) / (self.xb8tmaxsnr_high_sixg - self.xb8tminsnr_high_sixg), 2)). \
                                                otherwise(0))))))))))))))))))))))))))))))))))).\
                          withColumn("norm_rssi", func.when(col("norm_rssi")<=0,0).otherwise(func.when(col("norm_rssi") >=1,1).otherwise(col("norm_rssi")))). \
                          withColumn("norm_snr", func.when(col("norm_snr")  <= 0, 0).otherwise(func.when(col("norm_snr") >= 1, 1).otherwise(col("norm_rssi")))).\
        ...
        count_of_type_devices = combined_wifi_packets.groupBy("accountSourceId",
            ...
            withColumn("higher_modulation_higher_usage_devices_count", func.when(col("higher_modulation_higher_usage_devices_count").isNotNull(), col("higher_modulation_higher_usage_devices_count")).otherwise(0)). \
            ...
            withColumn("distributor", func.when(col("lower_modulation_higher_usage_devices_count")==0, col("distributor") + lit(self.lower_modulation_higher_usage_devices_weight)).otherwise(col("distributor"))).\
            withColumn("distributor", col("distributor")/(col("hmhu_flag")+col("hmlu_flag")+col("lmhu_flag")+col("lmlu_flag"))).\
            withColumn("higher_modulation_higher_usage_weight", func.when(((self.higher_modulation_higher_usage_devices_weight + col("distributor")) / func.col("higher_modulation_higher_usage_devices_count")).isNull(),0 ).\
                       otherwise(((self.higher_modulation_higher_usage_devices_weight + col("distributor")) / func.col("higher_modulation_higher_usage_devices_count")))).\
            withColumn("higher_modulation_lower_usage_weight", func.when(((self.higher_modulation_lower_usage_devices_weight + col("distributor")) / func.col("higher_modulation_lower_usage_devices_count")).isNull(),0).\
                       otherwise(((self.higher_modulation_lower_usage_devices_weight + col("distributor")) / func.col("higher_modulation_lower_usage_devices_count")))).\
            withColumn("lower_modulation_lower_usage_weight", func.when(((self.lower_modulation_lower_usage_devices_weight + col("distributor")) / func.col("lower_modulation_lower_usage_devices_count")).isNull(),0).\
                       otherwise(((self.lower_modulation_lower_usage_devices_weight + col("distributor")) / func.col("lower_modulation_lower_usage_devices_count")))).\
            withColumn("lower_modulation_higher_usage_weight", func.when(((self.lower_modulation_higher_usage_devices_weight + col("distributor")) / func.col("lower_modulation_higher_usage_devices_count")).isNull(),0).\
                       otherwise(((self.lower_modulation_higher_usage_devices_weight + col("distributor")) / func.col("lower_modulation_higher_usage_devices_count")))).\
            withColumn("total_weights", (col("higher_modulation_higher_usage_devices_count") * col("higher_modulation_higher_usage_weight")) +
        ...
        household_whix_pre = self.obj.join_two_frames(combined_wifi_packets,count_of_type_devices,"inner",["accountSourceId",
            ...
            select("accountSourceId",
                   ...
                   "total_weights").\
            withColumn("dot_product", func.when((col("med_maxtx")<444) & (col("packets_perc")<0.60), ((col("WIFI_HAPPINESS_INDEX")/100) * col("lower_modulation_lower_usage_weight"))).\
                            otherwise(func.when((col("med_maxtx")<444) & (col("packets_perc")>=0.60),((col("WIFI_HAPPINESS_INDEX")/100) * col("lower_modulation_higher_usage_weight"))).\
                            otherwise(func.when((col("med_maxtx")>=444)& (col("packets_perc")<0.60), ((col("WIFI_HAPPINESS_INDEX")/100) * col("higher_modulation_lower_usage_weight"))).\
                            otherwise(func.when((col("med_maxtx")>=444)& (col("packets_perc")>=0.60),((col("WIFI_HAPPINESS_INDEX")/100) * col("higher_modulation_higher_usage_weight"))))))).\
            groupBy("accountSourceId",
                    "deviceSourceId",
                    "AccountId",
                    "GW_MODEL",
